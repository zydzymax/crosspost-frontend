...
import {
  ...
  Check, ArrowRight, Sparkles, Cloud
} from 'lucide-react'
...
const features = [
  ...
  },
  {
    icon: Sparkles,
    title: 'AI-адаптация',
    description: 'Нейросеть адаптирует текст и медиа под каждую платформу. Умный кроп с сохранением лиц и важных объектов.',
  },
  {
    icon: Cloud,
...
const pricing = [
  ...
  },
  {
    ...
    features: ['100 постов/мес', 'Все платформы', 'AI-капшены', '50 генераций картинок', 'Google Drive / Яндекс.Диск', 'Приоритетная поддержка'],
    cta: 'Выбрать Pro',
    popular: true,
  },
  {
...
const faq = [
  {
    ...
    a: 'Telegram, VK, Instagram, Facebook, TikTok, YouTube и RuTube. Мы постоянно добавляем новые.',
  },
  {
    q: 'Как работает адаптация контента?',
    a: 'AI адаптирует текст под лимиты каждой платформы. Медиа автоматически кропается под нужные пропорции с сохранением лиц и важных объектов — без чёрных полос и искажений.',
  },
  {
    q: 'Как подключить облачное хранилище?',
    a: 'Создайте папку на Google Drive или Яндекс.Диске, разложите медиа по папкам videos/ и photos/, и дайте доступ сервису. Файлы автоматически синхронизируются и адаптируются под все платформы.',
  },
  {
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
            ...
            AI адаптирует текст и медиа под каждую платформу — умный кроп без чёрных полос.
          </p>
